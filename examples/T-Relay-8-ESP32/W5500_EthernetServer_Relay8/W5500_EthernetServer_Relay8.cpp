/*
 * @Description: LilyGo-T-Relay-8_W5500 Ethernet Server Test
    Instructions for use:
    This procedure is used to test the W5500 Ethernet module with LilyGo-T-Relay-8 extension.
 ...
 * @LastEditTime: 2023-07-21 15:39:32
 * @License: GPL 3.0
 */
#include <SPI.h>
#include <Ethernet.h>
...
void setup()
{
    ...
    pinMode(RELAY8_PIN_1, OUTPUT);
    pinMode(RELAY8_PIN_2, OUTPUT);
    pinMode(RELAY8_PIN_3, OUTPUT);
    pinMode(RELAY8_PIN_4, OUTPUT);
    pinMode(RELAY8_PIN_5, OUTPUT);
    pinMode(RELAY8_PIN_6, OUTPUT);
    pinMode(RELAY8_PIN_7, OUTPUT);
    pinMode(RELAY8_PIN_8, OUTPUT);
    pinMode(LED_PIN, OUTPUT);
    delay(100);

    // Turn off all relays
    digitalWrite(RELAY8_PIN_1, LOW);
    digitalWrite(RELAY8_PIN_2, LOW);
    digitalWrite(RELAY8_PIN_3, LOW);
    digitalWrite(RELAY8_PIN_4, LOW);
    digitalWrite(RELAY8_PIN_5, LOW);
    digitalWrite(RELAY8_PIN_6, LOW);
    digitalWrite(RELAY8_PIN_7, LOW);
    digitalWrite(RELAY8_PIN_8, LOW);
            ...
            {                           // if there's bytes to read from the client,
                ...
                { // if the byte is a newline character
                    ...
                    if (currentLine.length() == 0)
                    {
                        ...
                        client.println("</head><body><div align=\"center\"><h2>LilyGo-T-Relay-8_W5500 Ethernet Server Test</h2><br />");
                        ...
                        client.print("<h3>Click <a href=\"/Relay_7\">here</a> to change the Relay 7 state.<br></h3>");
                        client.print("<h3>Click <a href=\"/Relay_8\">here</a> to change the Relay 8 state.<br></h3>");
                ...
                if (currentLine.endsWith("GET /Relay_1"))
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        digitalWrite(RELAY8_PIN_1, HIGH);
                        break;
                ...
                if (currentLine.endsWith("GET /Relay_2"))
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        digitalWrite(RELAY8_PIN_2, HIGH);
                        break;
                ...
                if (currentLine.endsWith("GET /Relay_3"))
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        digitalWrite(RELAY8_PIN_3, HIGH);
                        break;
                ...
                if (currentLine.endsWith("GET /Relay_4"))
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        digitalWrite(RELAY8_PIN_4, HIGH);
                        break;
                ...
                if (currentLine.endsWith("GET /Relay_5"))
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        digitalWrite(RELAY8_PIN_5, HIGH);
                        break;
                ...
                if (currentLine.endsWith("GET /Relay_6"))
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        digitalWrite(RELAY8_PIN_6, HIGH);
                        break;
                ...
                if (currentLine.endsWith("GET /Relay_7"))
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        digitalWrite(RELAY8_PIN_7, HIGH);
                        break;
                ...
                if (currentLine.endsWith("GET /Relay_8"))
                {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        digitalWrite(RELAY8_PIN_8, HIGH);
                        break;
